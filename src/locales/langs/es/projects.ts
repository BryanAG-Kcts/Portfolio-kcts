...
export const projectsDesc = {
  ...
  game2048: 'Un juego con una táctica sencilla de analizar pero difícil de dominar, juega, haz puntos y guarda tu mejor record',
  ...
  backGame2048: 'Un juego con una táctica sencilla de analizar pero difícil de dominar, juega, haz puntos y guarda tu mejor record',
  ...
  kctsground: 'Un gran playground de código, simple y rápido. Comparte tu código con solo la Url o exporta tu código en pdf'
}
